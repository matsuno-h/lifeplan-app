...
import { Users, UserPlus, Trash2, Edit3, Eye, Loader2, AlertCircle, Check, X } from 'lucide-react';
...
export function ShareSettingsModal({ planId, isOwner, planNumber, onClose }: ShareSettingsModalProps) {
  const { user } = useAuth();
